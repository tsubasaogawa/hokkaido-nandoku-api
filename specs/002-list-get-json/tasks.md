...
-   **Task 1.1: Update `Placename` Model**
...
-   **Task 1.2: Implement `FindAll` Method in Repository**
...
-   **Task 2.1: Create `ListPlaceNames` Handler**
